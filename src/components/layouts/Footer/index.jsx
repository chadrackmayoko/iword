  ...
  return <footer className="vl-footer-bg-1">
      <Container>
            ...
            <div className="vl-footer-widget-2 pl-30 mb-30">
              ...
              <div className="vl-footer-menu">
                <ul>
                  ...
                  <li><Link to="/team">Volunteering</Link></li>
            ...
            <div className="vl-footer-widget-3 mb-30">
              ...
              <div className="vl-footer-icon-list">
                ...
                <div className="vl-footer-text">
                  <a href="mailto:support@charity.com">genimayoko@gmail.com</a>
                </div>
              </div>
              <div className="vl-footer-icon-list">
                <div className="vl-footer-icon">
                ...
                <div className="vl-footer-text">
                  <a href="#">388 Saint Sauveur <br /> Quebec, Qc G1N 2X9</a>
                </div>
              </div>
              <div className="vl-footer-icon-list">
                <div className="vl-footer-icon">
                ...
                <div className="vl-footer-text">
                  <a href="tel:1234567890">438-699-9094</a>
                </div>
              </div>
            </div>
          </Col>
        ...
        <div className="vl-copyright copyright-border-1">
          <Row>
            <Col md={6}>
              <p className="vl-copyright-text">© 2025 Synergie 360 ,Inc. All Rights Reserved.</p>
            </Col>
            <Col md={6}>
